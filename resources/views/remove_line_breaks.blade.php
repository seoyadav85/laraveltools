      ...
      <div class="container">
         <div class="sort-text-content">
            <div class="sort-text-heading">
               <h4>Remove Line Breaks</h4>
               <div class="sort-text-switch">
                  <div class="switch-wrap">
                    <div class="me-3  replacement" style="display: none">      
                          <label for='replacement' class='input-hint hidden-sm-up'>Specify character/s</label> 
                        <input id='replacement' class='input-sm xs-100' value='. '>
                    </div>
                  </div>
                  <div class="sort-select">
                     ...
                     <div class="sort-select-inner">
                        <select id="settings">
                        <option value='1'>Remove one</option>
                        <option value='2'>Replace with</option>
            ...
            <div class="sort-text-btn">
               ...
               <ul class="sort-clear-btn">
                  <button type="button" class="sort-btn" id="btnRemove">Remove</button>
...
<script type="text/javascript" src="{{asset('/public/js/remove_lines.js')}}"></script>
