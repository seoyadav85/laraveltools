         ...
         <div class="sort-text-content">
                  ...
                  <div class="sort-select">
                     ...
                     <div class="sort-select-inner">
                        <select id="settings">
                           ...
                           <option value="3" selected="">Natural (A-Z)</option>
            ...
            <div class="sort-text-btn">
               ...
               <ul class="sort-clear-btn">
                  <button type="button" class="sort-btn" id="btnSort">Sort</button>
...
<script type="text/javascript" src="{{asset('/public/js/sort_text.js')}}"></script>
