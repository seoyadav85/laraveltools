        ...
        <div class="sort-text-content">
            ...
            <div class="row sort-textbox-row">
                <div class="col-lg-6 sort-textbox-col">
                    <div class="insert-prefix-suffix find-replace">
                        <h5>Find this</h5>
                        <textarea id="find" placeholder="Dog"></textarea>
                    </div>
                </div>
                <div class="col-lg-6 sort-textbox-col">
                    <div class="insert-prefix-suffix find-replace">
                        <h5>Replace it with</h5>
                        <textarea id="replace" placeholder="Cat"></textarea>
                    </div>
                </div>
                <div class="col-lg-6 sort-textbox-col">
            ...
            <div class="sort-text-btn">
                ...
                <ul class="sort-clear-btn">
                    <button type="button" class="sort-btn" id="btnReplace">Replace</button>
...
<script type="text/javascript" src="{{asset('/public/js/find_replace.js')}}"></script>
