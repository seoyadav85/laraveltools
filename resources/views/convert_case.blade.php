         ...
         <div class="sort-text-content">
                  ...
                  <div class="sort-select">
                     ...
                     <div class="sort-select-inner">
                        <select id="settings">
                            ...
                            <!-- <option  value="4">AP Title Case</option> -->
                            <option  value="4">Each Word</option>
                            <option  value="5" selected="">Sentence case</option>
                            <option  value="6">ranDOm CasE</option>
                        </select>
                     </div>
                  </div>
               </div>
                           ...
                           <li>
                              <div class="dropdown file-dropdown">
                                 ...
                                 <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li>
                                       <a class="dropdown-item" href="#" id="file_new">
                                       <i class="fa fa-file-o" aria-hidden="true"></i>
                                       New Document
                                       </a>
                                    </li>
                                    <li>
                                       <a class="dropdown-item" href="#" id="open_file">
                                       <i class="fa fa-eye" aria-hidden="true"></i>Open
                                       </a>
                                    </li>
                                    <li>
                                       <a class="dropdown-item" href="#" id="file_download">
                                       <i class="fa fa-floppy-o" aria-hidden="true"></i>Save As
                                       </a>
                                    </li>
                                    <li>
                                       <a class="dropdown-item" href="#" id="file_print">
            ...
            <div class="sort-text-btn">
               ...
               <ul class="sort-clear-btn">
                  <button type="button" class="sort-btn" id="convertBtn">Convert</button>
...
<script type="text/javascript" src="{{asset('/public/js/convert_text.js')}}"></script>
