         ...
         <div class="sort-text-content">
               ...
               <div class="sort-text-switch">
                  <div class="sort-select">
                     ...
                     <div class="sort-select-inner">
                        <select id="settings">
                        <option value='1'>Reverse all</option>
                        <option value='2'>Reverse each line</option>
                        </select>
                     </div>
                  </div>
               </div>
            ...
            <div class="sort-text-btn">
               ...
               <ul class="sort-clear-btn">
                  <button type="button" class="sort-btn" id="revText">Reverse</button>
...
<script>
$("#txtArea").attr('placeholder','ABCDEFGHIJKLMNOPQRSTUVWXYZ\nabcdefghijklmnopqrstuvwxyz');
$("#txtArea1").attr('placeholder','zyxwvutsrqponmlkjihgfedcba\nZYXWVUTSRQPONMLKJIHGFEDCBA');
$("#revText").click(function() {
    var e = $("#txtArea").val(),
        t = $("#settings").val();
    if (1 == t) e = e.split("").reverse().join("");
    else if (2 == t) {
        for (var n = 0, e = e.replace(/\r\n|\r|\n/gm, "\n").split("\n"), n = 0; n < e.length; n++) e[n] = e[n].split("").reverse().join("");
        e = e.join("\n")
    }
    $("#txtArea1").val(e);
});
