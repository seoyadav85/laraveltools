...
<div class="container">
    <div class="sort-text-content">
        <div class="sort-text-heading">
            <h4>Add Prefix and/or Suffix into Each Line</h4>
            <div class="sort-text-switch">
                <div class="switch-wrap">
                    <span>Exclude Empty Lines</span>
                    <label class="switch">
                        <input type="checkbox" id="exculed">
        ...
        <div class="row sort-textbox-row">
            <div class="col-lg-6 sort-textbox-col">
                <div class="insert-prefix-suffix">
                    <h5>Prefix</h5>
                    <p>Insert this at the beginning of each line</p>
                    <textarea id="prefix" placeholder="A"></textarea>
                </div>
            </div>
            <div class="col-lg-6 sort-textbox-col">
                <div class="insert-prefix-suffix">
                    <h5>Suffix</h5>
                    <p>Insert this at the end of each line</p>
                    <textarea id="surfix" placeholder="B"></textarea>
                </div>
            </div>
            <div class="col-lg-6 sort-textbox-col">
        ...
        <div class="sort-text-btn">
            <button type="button" class="copy-btn"><img src="{{asset('public/images/copy-icon.svg')}}" alt=""> Copy</button>
            <ul class="sort-clear-btn">
               <button type="button" class="sort-btn" id="btnApply">Appy</button>
...
<script type="text/javascript" src="{{asset('/public/js/prefix_surfix.js')}}"></script>
