...
<div class="sort-text-content">
    ...
    <div class="row sort-textbox-row">
        <div class="col-lg-7 sort-textbox-col">
            <div class=" sort-textbox">
                ...
                <div class="textarea-wrap">
                    ...
                    <textarea class="form-control textbox" cols="50" id="txtArea"></textarea>
                </div>
            </div>
        </div>
        <div class="col-lg-5 sort-textbox-col">
            <div class="sort-textbox">
                <div class="sort-textbox-heading">
                    <h5>Statistics</h5>
                </div>
                <div class="statistics-wrap">
                    <ul class="statistics">
                        <li><span>Words</span>
                            <span id="total_words">235</span>
                        </li>
                        <li><span>Characters</span>
                            <span id="total_char">1,584</span>
                        </li>
                        <li><span>Characters excluding spaces</span>
                            <span id="total_charNS">1,348</span>
                        </li>
                        <li><span>Sentences</span>
                            <span id="total_sentences">26</span>
                        </li>
                        <li><span>Paragraphs</span>
                            <span id="total_paragraphs">3</span>
                        </li>
                        <li><span>Total Lines</span>
                            <span id="total_lines">5</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="sort-text-btn">
        <button type="button" class="copy-btn"><img src="{{asset('public/images/copy-icon.svg')}}" alt="">
            Copy</button>
        <ul class="sort-clear-btn">
            <!-- <button type="button" class="sort-btn" id="btnSort">Count</button> -->
...
<script type="text/javascript" src="{{asset('/public/js/word_count.js')}}"></script>
